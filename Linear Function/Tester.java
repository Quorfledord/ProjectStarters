...
public class Tester
{
	public static void main(String args[])
	{
		while(true)
		{
			...
			System.out.println("The y value corresponding to x = " + x
							+ " is " + yValue);
			System.out.print("\nGive any y value:  ");
			double y = kbReader.nextDouble();
			double xValue = line.getXvalue(y);
			System.out.println("The x value corresponding to y = " + y
							+ " is " + xValue);

			System.out.print("Do you wish to enter more values? Y or N: ");

			if( kbReader.next().toLowerCase().equals("n") )
				break;
		}
	}
}
